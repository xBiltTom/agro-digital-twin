...
class ExternalModel(Base, TimestampMixin):
    ...
    bundle_contract_version: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    learning_mode: Mapped[Optional[str]] = mapped_column(String(30), nullable=True)
    training_data_type: Mapped[Optional[str]] = mapped_column(String(40), nullable=True)
