    ...
    <div className="flex flex-col gap-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        {canRunSimulations && (
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-zinc-950 text-xs font-semibold shadow-lg shadow-emerald-500/20 transition cursor-pointer"
          >
              ...
              return (
                <div
                  ...
                  className={`p-4 rounded-xl border text-left cursor-pointer transition flex flex-col gap-2.5 ${
                    isSelected
                      ? "bg-zinc-900 border-emerald-500/60 shadow-lg shadow-emerald-950/40 ring-1 ring-emerald-500/30"
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-2 text-[11px] text-zinc-400 font-mono">
                    <div>
                      ...
                      <span className="text-zinc-300 font-semibold">{sim.duration_days} días</span>
                    </div>
                    <div>
                      <span className="text-zinc-400">Lluvia Total: </span>
                      <span className="text-zinc-300 font-semibold">
                        {sim.summary_metrics?.total_precip_mm ?? "-"} mm
                      </span>
                    </div>
                    <div>
                      <span className="text-zinc-400">Volumen Río: </span>
        ...
        <div className="lg:col-span-8 flex flex-col gap-6">
          {selectedSim ? (
            <>
              ...
              <div className="p-6 rounded-2xl bg-zinc-900/60 border border-zinc-800 flex flex-col gap-4 shadow-xl">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-zinc-800/80">
                  <div className="flex flex-col">
                    <div className="flex items-center gap-2">
                      <h2 className="text-base font-bold text-zinc-100">{selectedSim.name}</h2>
                    ...
                    {isWsConnected && (
                      <div className="flex items-center gap-1 bg-zinc-950 px-2 py-1 rounded-lg border border-zinc-800 text-[11px] font-mono">
                        <button
                          ...
                          className={`px-1.5 py-0.5 rounded ${wsSpeed === 1 ? "bg-zinc-800 text-white" : "text-zinc-500"}`}
                        >
                          1x
                        </button>
                        <button
                          onClick={() => handleWsSpeedChange(5)}
                          className={`px-1.5 py-0.5 rounded ${wsSpeed === 5 ? "bg-zinc-800 text-white" : "text-zinc-500"}`}
                        >
                          5x
                        </button>
                        <button
                          onClick={() => handleWsSpeedChange(20)}
                          className={`px-1.5 py-0.5 rounded ${wsSpeed === 20 ? "bg-zinc-800 text-white" : "text-zinc-500"}`}
                        >
                          20x
                        </button>
                      </div>
                ...
                {isWsConnected && liveTick && (
                  <div className="p-4 rounded-xl bg-gradient-to-r from-emerald-950/40 via-zinc-950 to-cyan-950/40 border border-emerald-500/40 grid grid-cols-2 sm:grid-cols-4 gap-3 animate-fadeIn">
                    <div className="flex flex-col">
                      <span className="text-[10px] uppercase font-mono text-zinc-400">Día / Fecha</span>
                    ...
                    <div className="flex flex-col">
                      <span className="text-[10px] uppercase font-mono text-emerald-400">Micro (Planta)</span>
                    ...
                    <div className="flex flex-col">
                      <span className="text-[10px] uppercase font-mono text-cyan-400">Meso (Suelo)</span>
                    ...
                    <div className="flex flex-col">
                      <span className="text-[10px] uppercase font-mono text-teal-400">Macro (SWAT)</span>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 text-xs">
                  <div className="p-3 rounded-xl bg-zinc-950 border border-zinc-800">
                    <span className="text-[10px] font-mono text-zinc-400 block">Precipitación Total</span>
                    <span className="text-sm font-bold text-zinc-100 mt-1 block">
                      {selectedSim.summary_metrics?.total_precip_mm ?? "-"} mm
                    </span>
                  </div>
                  <div className="p-3 rounded-xl bg-zinc-950 border border-zinc-800">
                    <span className="text-[10px] font-mono text-zinc-400 block">Volumen en Río</span>
                    <span className="text-sm font-bold text-teal-400 mt-1 block">
                      {selectedSim.summary_metrics?.total_discharge_hm3 ?? "-"} hm³
                    </span>
                  </div>
                  <div className="p-3 rounded-xl bg-zinc-950 border border-zinc-800">
                    <span className="text-[10px] font-mono text-zinc-400 block">Caudal Máximo Pico</span>
                    <span className="text-sm font-bold text-zinc-100 mt-1 block">
                      {selectedSim.summary_metrics?.peak_streamflow_m3s ?? "-"} m³/s
                    </span>
                  </div>
                  <div className="p-3 rounded-xl bg-zinc-950 border border-zinc-800">
                    <span className="text-[10px] font-mono text-zinc-400 block">Evapotranspiración</span>
                    <span className="text-sm font-bold text-cyan-400 mt-1 block">
                      {selectedSim.summary_metrics?.total_actual_et_mm ?? "-"} mm
                    </span>
                  </div>
                  <div className="p-3 rounded-xl bg-zinc-950 border border-zinc-800">
                    <span className="text-[10px] font-mono text-zinc-400 block">Estrés de Sequía</span>
                    <span className="text-xs font-bold text-emerald-400 mt-1.5 block truncate">
              ...
              <div className="p-6 rounded-2xl bg-zinc-900/40 border border-zinc-800 shadow-xl flex flex-col gap-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <Mountain className="w-4 h-4 text-teal-400" />
                    <h3 className="text-xs font-semibold text-zinc-100 uppercase tracking-wide">
                      Hidrograma de Cuenca SWAT: Caudal Fluvial (m³/s) y Precipitación (mm)
                    </h3>
                  </div>
                  <span className="text-[11px] font-mono text-zinc-400">Escala Macro</span>
                </div>
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                      <ComposedChart data={chartData}>
                        ...
                        <YAxis
                          ...
                          fontSize={10}
                          tickLine={false}
                          label={{ value: "Caudal (m³/s)", angle: -90, position: "insideLeft", fill: "#2dd4bf", fontSize: 10 }}
                        />
                        <YAxis
                          yAxisId="right"
                          orientation="right"
                          ...
                          fontSize={10}
                          tickLine={false}
                          label={{ value: "Lluvia (mm)", angle: 90, position: "insideRight", fill: "#38bdf8", fontSize: 10 }}
                        />
                        <Tooltip
              ...
              <div className="p-6 rounded-2xl bg-zinc-900/40 border border-zinc-800 shadow-xl flex flex-col gap-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] font-mono text-zinc-400">Escala Micro</span>
                </div>
                  ...
                  <div className="h-64 w-full">
                    <ResponsiveContainer width="100%" height="100%">
                      <LineChart data={chartData}>
                        <CartesianGrid strokeDasharray="3 3" stroke="#27272a" vertical={false} />
                        <XAxis dataKey="date_str" stroke="#71717a" fontSize={10} tickLine={false} />
                        <YAxis stroke="#a1a1aa" fontSize={10} tickLine={false} label={{ value: "mm / día", angle: -90, position: "insideLeft", fill: "#a1a1aa", fontSize: 10 }} />
                        <Tooltip
                          contentStyle={{ backgroundColor: "#09090b", borderColor: "#27272a", borderRadius: "8px", fontSize: "11px" }}
                        />
                        <Legend wrapperStyle={{ fontSize: "11px" }} />
                        <Line type="monotone" dataKey="potential_et_mm" name="Demanda Atmosférica ET0 (mm/d)" stroke="#fb923c" strokeWidth={1.5} dot={false} strokeDasharray="4 4" />
                        <Line type="monotone" dataKey="plant_transpiration_mm" name="Transpiración Real Planta (mm/d)" stroke="#10b981" strokeWidth={2} dot={false} />
                        <Line type="monotone" dataKey="sap_flow_velocity_cmh" name="Velocidad Savia (cm/h)" stroke="#38bdf8" strokeWidth={1.5} dot={false} />
                      </LineChart>
                    </ResponsiveContainer>
                  </div>
                )}
              ...
              <div className="p-6 rounded-2xl bg-zinc-900/40 border border-zinc-800 shadow-xl flex flex-col gap-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] font-mono text-zinc-400">Escala Meso (Parcela)</span>
                </div>
                  ...
                  <div className="h-60 w-full">
                    <ResponsiveContainer width="100%" height="100%">
                      <AreaChart data={chartData}>
                        <CartesianGrid strokeDasharray="3 3" stroke="#27272a" vertical={false} />
                        <XAxis dataKey="date_str" stroke="#71717a" fontSize={10} tickLine={false} />
                        <YAxis stroke="#38bdf8" fontSize={10} tickLine={false} label={{ value: "Humedad θ (%)", angle: -90, position: "insideLeft", fill: "#38bdf8", fontSize: 10 }} />
                        <Tooltip
                          contentStyle={{ backgroundColor: "#09090b", borderColor: "#27272a", borderRadius: "8px", fontSize: "11px" }}
                        />
                        <Legend wrapperStyle={{ fontSize: "11px" }} />
                        <Area type="monotone" dataKey="soil_moisture_vol" name="Humedad Volumétrica (%)" stroke="#0ea5e9" fill="#0ea5e9" fillOpacity={0.2} strokeWidth={2} />
                        <Line type="monotone" dataKey="cwsi_stress_index" name="Estrés CWSI (0 a 1)" stroke="#f43f5e" strokeWidth={1.5} dot={false} />
                      </AreaChart>
                    </ResponsiveContainer>
                  </div>
                )}
            ...
            <div className="p-12 rounded-2xl border border-zinc-800 text-center text-zinc-500 text-xs">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/75 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="w-full max-w-lg bg-zinc-900 border border-zinc-800 rounded-2xl p-6 shadow-2xl flex flex-col gap-4">
            ...
            <form onSubmit={handleCreateSimulation} className="flex flex-col gap-4 text-xs">
              <div>
                <label className="block font-mono uppercase text-zinc-400 mb-1 font-medium">
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-lg bg-zinc-950 border border-zinc-800 text-zinc-200 focus:outline-none focus:border-emerald-500/80"
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2.5 rounded-lg bg-zinc-950 border border-zinc-800 text-zinc-200 focus:outline-none focus:border-emerald-500/80"
                  >
                    {watersheds.map((w) => (
              ...
              <div className="p-3 rounded-lg bg-zinc-950/80 border border-zinc-800 text-[11px] text-zinc-400 flex flex-col gap-1">
                <span className="font-semibold text-zinc-300">Cultivo acoplado: Palto Hass (Persea americana)</span>
              ...
              <div className="flex items-center justify-end gap-3 pt-4 border-t border-zinc-800">
                <button
                  ...
                  className="px-4 py-2 rounded-lg bg-zinc-800 hover:bg-zinc-700 text-zinc-300 font-medium transition cursor-pointer"
                >
                  Cancelar
                </button>
                <button
                  ...
                  className="px-5 py-2 rounded-lg bg-emerald-500 hover:bg-emerald-400 text-zinc-950 font-semibold transition flex items-center gap-2 cursor-pointer disabled:opacity-50"
                >
                  {isSubmitting ? (
                    <>
