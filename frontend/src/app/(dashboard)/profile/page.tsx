    ...
    <div className="flex flex-col gap-8 max-w-4xl mx-auto">
      ...
      <div className="flex flex-col gap-1">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl font-bold text-zinc-100">Mi Perfil de Investigador</h1>
        </div>
      ...
      <div className="p-6 rounded-2xl bg-zinc-900/60 border border-zinc-800 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-emerald-600 to-cyan-500 p-[1.5px]">
            <div className="w-full h-full bg-zinc-950 rounded-[14.5px] flex items-center justify-center text-cyan-300 font-bold text-xl">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-wrap gap-1.5 mt-2">
              {user?.roles?.map((r) => (
                <span
                  key={r.name}
                  className="text-[10px] font-mono px-2 py-0.5 rounded bg-cyan-950/80 text-cyan-300 border border-cyan-800/60 flex items-center gap-1"
                >
        ...
        <form onSubmit={handleUpdateProfile} className="flex flex-col gap-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 rounded-lg bg-zinc-950 border border-zinc-800 text-zinc-200 text-xs focus:outline-none focus:border-emerald-500/80"
              />
            </div>
          ...
          <div className="flex justify-end">
            <button
              ...
              className="px-4 py-2.5 rounded-lg bg-emerald-500 hover:bg-emerald-400 text-zinc-950 font-semibold text-xs transition flex items-center gap-2 cursor-pointer disabled:opacity-50"
            >
              {isSavingProfile ? (
        ...
        <form onSubmit={handleChangePassword} className="flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              placeholder="••••••••"
              className="w-full px-3.5 py-2.5 rounded-lg bg-zinc-950 border border-zinc-800 text-zinc-200 text-xs focus:outline-none focus:border-amber-500/80"
            />
          </div>
          ...
          <div className="flex justify-end">
            <button
              ...
              className="px-4 py-2.5 rounded-lg bg-amber-500 hover:bg-amber-400 text-zinc-950 font-semibold text-xs transition flex items-center gap-2 cursor-pointer disabled:opacity-50"
            >
              {isChangingPwd ? (
                <Loader2 className="w-3.5 h-3.5 animate-spin" />
              ) : (
